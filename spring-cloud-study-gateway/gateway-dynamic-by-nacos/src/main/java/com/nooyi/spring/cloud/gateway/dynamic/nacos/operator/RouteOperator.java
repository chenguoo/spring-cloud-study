package com.nooyi.spring.cloud.gateway.dynamic.nacos.operator;
...
public class RouteOperator {
    ...
    public RouteOperator(ObjectMapper objectMapper, RouteDefinitionWriter routeDefinitionWriter,
